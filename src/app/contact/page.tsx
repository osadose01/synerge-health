        ...
        <section className="py-40 bg-[#060B09] border-t border-[rgba(43,224,176,0.06)]">
          <div className="container mx-auto px-8 md:px-16">
            <div className="grid md:grid-cols-[1fr_1.6fr] gap-24 items-start">
              ...
              <div className="space-y-12">
                ...
                <div className="space-y-8">
                  <div className="space-y-1.5">
                    <p className="text-[11px] font-mono uppercase tracking-widest text-[#8FA39A]">Email</p>
                    <a
                      href="mailto:hello@synergehealth.com"
                      className="text-sm font-medium text-[#F2F6F4] hover:text-[#2BE0B0] transition-colors"
                    >
                  ...
                  <div className="space-y-1.5">
                    <p className="text-[11px] font-mono uppercase tracking-widest text-[#8FA39A]">Hub Locations</p>
                    <p className="text-sm text-[#F2F6F4]">Lagos, Nigeria &amp; London, UK</p>
                  </div>

                  <div className="space-y-1.5">
                    <p className="text-[11px] font-mono uppercase tracking-widest text-[#8FA39A]">Media &amp; Press</p>
                    <a
              ...
              {/* Form */}
              <div>
                <h2 className="font-display font-bold text-3xl md:text-4xl text-[#F2F6F4] leading-[1.1] mb-10">
                  Send us a message.
                </h2>
                <ContactForm />
              </div>
