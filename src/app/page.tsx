  ...
  return (
    <div ref={ref} className="space-y-4 my-8">
      ...
      <div className="space-y-2">
        <div className="flex justify-between font-mono text-[11px] tracking-[0.15em] text-[#C2D1CB] uppercase">
          <span>Africa&rsquo;s Global Disease Burden</span>
          <span className="text-[#2BE0B0] font-bold">22%</span>
        </div>
        <div className="h-2 bg-[#0D1815] rounded-full overflow-hidden border border-white/[0.1]">
          <motion.div
      ...
      <div className="flex-1 space-y-2 w-full">
        <div className="font-mono text-[11px] tracking-[0.15em] text-[#C2D1CB] uppercase">
          Infrastructure
        </div>
        <div className="h-2 bg-[#0D1815] rounded-full overflow-hidden border border-white/[0.1]">
          <motion.div
