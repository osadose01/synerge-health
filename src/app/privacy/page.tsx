        ...
        <section className="py-24 bg-[#060B09]">
          <div className="container mx-auto px-6 md:px-12 max-w-3xl space-y-8 text-xs sm:text-sm text-[#8FA39A] leading-relaxed">
            <div className="space-y-3">
              <h3 className="font-display font-bold text-lg text-[#F2F6F4]">1. Information We Collect</h3>
              <p>
            ...
            <div className="space-y-3">
              <h3 className="font-display font-bold text-lg text-[#F2F6F4]">2. How We Use Information</h3>
              <p>
            ...
            <div className="space-y-3">
              <h3 className="font-display font-bold text-lg text-[#F2F6F4]">3. Data Security & Cloudflare Storage</h3>
              <p>
            ...
            <div className="space-y-3">
              <h3 className="font-display font-bold text-lg text-[#F2F6F4]">4. Your Data Rights</h3>
              <p>
                You may request access to, correction of, or complete deletion of your personal data at any time by contacting our compliance office at <a href="mailto:privacy@synergehealth.com" className="text-[#2BE0B0] underline">privacy@synergehealth.com</a>.
              </p>
            </div>
          </div>
        </section>
