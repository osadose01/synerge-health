        ...
        <section className="py-24 bg-forest-950">
          <div className="container mx-auto px-6 md:px-12 max-w-3xl space-y-8 text-xs sm:text-sm text-muted leading-relaxed">
            <div className="space-y-3">
              <h3 className="font-heading font-bold text-lg text-cream-50">1. Acceptance of Terms</h3>
              <p>
            ...
            <div className="space-y-3">
              <h3 className="font-heading font-bold text-lg text-cream-50">2. Founder Application Confidentiality</h3>
              <p>
            ...
            <div className="space-y-3">
              <h3 className="font-heading font-bold text-lg text-cream-50">3. Intellectual Property</h3>
              <p>
